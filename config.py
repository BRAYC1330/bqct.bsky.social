...
HTTP_BACKOFF = _env_float("HTTP_BACKOFF", 1.5)
...
ALLOWED_LINK_DOMAINS = frozenset(os.getenv("ALLOWED_LINK_DOMAINS", "bsky.app,atproto.com,chainbase.com,tavily.com").split(","))
